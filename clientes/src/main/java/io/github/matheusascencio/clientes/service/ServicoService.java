...
import io.github.matheusascencio.clientes.model.repository.ClienteRepository;
import io.github.matheusascencio.clientes.model.repository.ServicoRepository;
...
public class ServicoService {
    ...
    //Construtor
    @Autowired
    public ServicoService(ClienteRepository cli, ServicoRepository serv) {
        this.cliRepo = cli;
        this.servRepo = serv;
    }
